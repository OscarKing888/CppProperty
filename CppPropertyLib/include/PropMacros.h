...
#define DeclProp(T, name)			protected: T name;  public: T Get##name() const { return name; } void Set##name(const T& val){name = val;}
#define DeclPropConstRef(T, name)	protected: T name;  public: const T& Get##name() const { return name; } void Set##name(const T& val){name = val;}
...
{																										\
	...
	IPropertyPtr prop = X_NEW propertyClassName(												\
