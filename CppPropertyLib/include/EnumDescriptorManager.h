...
typedef std::map<String, IEnumDescriptor*> EnumStringMap;
...
#define M_ImpEnumDescriptor(d) static d __##d;
/**
...
protected:
	...
	typedef std::map<int, String>		Enum2StrMap;
	typedef std::map<String, int>		Str2EnumMap;
