...
{
	char tmp[MAX_TMP_STR_BUFFER_SIZE];
	memset(tmp, 0, MAX_TMP_STR_BUFFER_SIZE * sizeof(char));

	va_list args;
	va_start(args, fmtStr);
	_vsnprintf(tmp, MAX_TMP_STR_BUFFER_SIZE, fmtStr, args);
	va_end(args);
...
// StringConverterBase
//-----------------------------------------------------------------------
String StringConverter::toString(float val, unsigned short precision, unsigned short width, char fill, std::ios::fmtflags flags)
{
