...
//--------------------------------------------------------------------------------
NameValuePairList PropertyObject::GetValues() const
{
	NameValuePairList nvps;
...
//--------------------------------------------------------------------------------
void PropertyObject::SetValues(const NameValuePairList& values)
{
	NameValuePairList::const_iterator i = values.begin();
	for (; i != values.end(); ++i)
	{
